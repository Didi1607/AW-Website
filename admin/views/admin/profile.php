        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Hi, welcome back! <?= $animal['username'] ?></h4>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-4 col-sm-4 border-right-1 prf-col">
                                            <div class="profile-name">
                                                ...
                                                <p><i class="fa-solid fa-file-signature"></i> UX / UI Designer</p>
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-sm-4 border-right-1 prf-col">
                                        ...
                                        <div class="col-xl-4 col-sm-4 prf-col">
                                            <div class="profile-call">
                                                <h4 class="text-muted">Địa chỉ</h4>
                                                <p><?= $animal['address'] ?></p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="pt-3">
                                            <div class="settings-form">
                                                ...
                                                <form style="color: #000    ;">
                                                    ...
                                                    <a href="?request=edit-user&id=<?= $animal['Id'] ?>" class="btn btn-danger p-2 m-3 w-25">Update Profile</a>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
